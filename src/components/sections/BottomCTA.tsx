...
const BottomCTA = () => (
    <section id="cta" className="container mx-auto my-24 px-8 2xl:px-32">
        <div className="flex flex-col md:flex-row mx-auto items-center justify-between px-8 lg:px-16 py-16 lg:py-24 bg-base-100 border border-neutral rounded-2xl">
            ...
            <div className="w-full md:w-auto shrink-0 flex justify-end mt-8">
                <a href="mailto:ethansaso@berkeley.edu" className="w-full md:w-auto text-md font-medium flex items-center justify-center bg-base-content text-primary-content py-2 px-4 rounded-full border-neutral border hover:scale-110 hover:bg-neutral-content transition duration-300">
