        ...
        <div className="mb-8 w-full">
          ...
          <div className="text-md font-medium flex items-end flex-col md:flex-row leading-relaxed">
            <p className="text-neutral-content max-w-2xl">
              I'm always exploring new skills and technologies to enhance my
              work. As I learn, I discover more innovative and effective
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex flex-col border border-neutral bg-base-200 rounded-2xl w-full p-8">
              <div>
                ...
                <p className="h2 mb-6 text-neutral-content text-[16px]">
                  I'm passionate about crafting interactive, user-friendly sites
            ...
            <div className="flex flex-col border border-neutral bg-base-200 rounded-2xl w-full p-8">
              <div>
                ...
                <p className="h2 mb-6 text-neutral-content text-[16px]">
                  I love designing complex systems and take pride in engineering
                  scalable solutions.
                </p>
              </div>
            ...
            <div className="flex flex-col border border-neutral bg-base-200 rounded-2xl w-full p-8">
              <div>
                ...
                <p className="h2 mb-6 text-neutral-content text-[16px]">
                  I believe in leveraging data to solve diverse problems and
