    ...
    return (
        <div id="projects" className="container flex flex-col max-w-7xl mx-auto items-center justify-center mt-16 px-8 lg:px-16 mb:24 lg:mb-32">
            ...
            <div className="project-section flex flex-row gap-8 flex-wrap">
                <div className="bg-base-300 border border-neutral rounded-2xl flex flex-col lg:flex-row items-center md:w-[45%] lg:w-full w-full flex-grow lg:p-8">
                    ...
                    <div className="h-full p-8 lg:p-0 flex-grow lg:pl-8 flex flex-col lg:w-[60%] w-full">
                        ...
                        <a href="https://taxokeys.org" className="w-full text-center rounded-2xl border border-neutral mt-4 lg:mt-2 p-2 hover:border-accent hover:text-accent bg-base-100 transition-all">Visit Site</a>
                    </div>
                </div>
                <div className="bg-base-300 border border-neutral rounded-2xl flex flex-col lg:flex-row-reverse items-center md:w-[45%] lg:w-full w-full flex-grow lg:p-8">
                    <div className="w-full lg:w-[40%] flex items-center">
                    ...
                    <div className="h-full p-8 lg:p-0 flex-grow lg:pr-8 flex flex-col lg:w-[60%] w-full">
                        ...
                        <a href="https://github.com/sammooredev/WebRecon2" className="w-full text-center rounded-2xl border border-neutral mt-4 lg:mt-2 p-2 hover:border-accent hover:text-accent bg-base-100 transition-all">Visit Site</a>
                    </div>
                </div>
                <div className="bg-base-300 border border-neutral rounded-2xl flex flex-col lg:flex-row items-center md:w-[45%] lg:w-full w-full flex-grow lg:p-8">
                    <div className="w-full lg:w-[40%] flex items-center"> 
                    ...
                    <div className="h-full p-8 lg:p-0 flex-grow lg:pl-8 flex flex-col lg:w-[60%] w-full">
                        ...
                        <a href="https://ethansaso.github.io/cal-mens-volleyball" className="w-full text-center rounded-2xl border border-neutral mt-4 lg:mt-2 p-2 hover:border-accent hover:text-accent bg-base-100 transition-all">Visit Site</a>
                    </div>
                </div>
            </div>
        </div>
