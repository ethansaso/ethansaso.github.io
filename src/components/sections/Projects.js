        ...
        <div id="projects" className="container flex flex-col mx-auto items-center justify-center px-8 2xl:px-32">
            <div className="mb-12 w-full">
                ...
                <div className="flex items-start md:items-end flex-col md:flex-row gap-3">
                    ...
                    <a href="https://github.com/ethansaso" className="text-lg flex-grow text-right text-primary hover:underline hover:text-secondary font-semibold text-nowrap">Visit my GitHub<FontAwesomeIcon size="xs" icon="fa-solid fa-arrow-right" className="ml-2"/></a>
                </div>
            </div>
            <div className="project-section grid lg:grid-cols-2 gap-8 max-w-6xl">
                <Reveal width='w-full' from='bottom'>
                    <div className="project-card rounded-2xl flex flex-col lg:flex-col items-center flex-grow group overflow-hidden">
                        <div className="absolute w-[170%] h-[170%] -top-1/3 md:-top-1/2 -right-0 md:-right-2/3 group-hover:scale-110 group-hover:opacity-40 transition duration-300 bg-gradient-c from-lime-700 to-transparent to-[80%] opacity-30 -z-20"/>
                        <div className="h-full p-8 flex-grow flex flex-col w-full">
                            <div className="w-full border-b border-neutral mb-6">
                                ...
                                <h2 className="text-md text-secondary">MERN stack, Python, Digital Ocean</h2>
                            </div>
                            <div className="flex-grow text-neutral-content mb-8">
                            ...
                            <div className="layered-button-frame">
                                <button href="https://taxokeys.org">
                                    <div className="bg-base-content text-primary-content py-2 px-4 rounded-full border-neutral border text-sm hover:scale-110 hover:bg-neutral-content transition duration-300">Visit Site<FontAwesomeIcon size="xs" icon="fa-solid fa-arrow-right" className="ml-2"/></div>
                                </button>
                            </div>
                        </div>
                ...
                <Reveal width='w-full' from='bottom'>
                    <div className="project-card rounded-2xl flex flex-col lg:flex-col items-center flex-grow h-full group overflow-hidden">
                        <div className="absolute w-[170%] h-[170%] -top-1/3 md:-top-1/2 -right-0 md:-right-2/3 group-hover:scale-110 group-hover:opacity-40 transition duration-300 bg-gradient-c from-yellow-500 to-transparent to-[80%] opacity-30 -z-20"/>
                        <div className="h-full p-8 flex-grow flex flex-col w-full">
                            <div className="w-full border-b border-neutral mb-6">
                            ...
                            <div className="layered-button-frame mt-8">
                                <button href="https://ethansaso.github.io/cal-mens-volleyball">
                                    <div className="bg-base-content text-primary-content py-2 px-4 rounded-full border-neutral border text-sm hover:scale-110 hover:bg-neutral-content transition duration-300">Visit Site<FontAwesomeIcon size="xs" icon="fa-solid fa-arrow-right" className="ml-2"/></div>
                                </button>
                                <button href="https://github.com/ethansaso/cal-mens-volleyball">
                                    <div className="glass-mid py-2 px-4 rounded-full border-neutral border text-sm hover:scale-110 transition duration-300">GitHub<FontAwesomeIcon size="xs" icon="fa-solid fa-arrow-right" className="ml-2"/></div>
                                </button>
                            </div>
                        </div>
                        <div className="w-full flex items-center">
                ...
                <Reveal width='w-full' from='bottom'>
                    <div className="project-card rounded-2xl flex flex-col items-center flex-grow group overflow-hidden">
                        <div className="absolute w-[170%] h-[170%] -top-1/3 md:-top-1/2 -right-0 md:-right-2/3 group-hover:scale-110 group-hover:opacity-40 transition duration-300 bg-gradient-c from-indigo-700 to-transparent to-[80%] opacity-30 -z-20"/>
                        <div className="h-full p-8 flex-grow flex flex-col w-full">
                            <div className="w-full border-b border-neutral mb-2">
                                <h1 className="text-4xl font-bold">WebRecon2</h1>
                                <h2 className="text-md text-primary">Golang, Amass, DNSGen, ...</h2>
                            </div>
                            <div className="flex-grow text-neutral-content mb-8">
                            ...
                            <div className="layered-button-frame">                                
                                <button href="https://github.com/sammooredev/WebRecon2">
                                    <div className="glass-mid py-2 px-4 rounded-full border-neutral border text-sm hover:scale-110 transition duration-300">GitHub<FontAwesomeIcon size="xs" icon="fa-solid fa-arrow-right" className="ml-2"/></div>
                                </button>
                            </div>
                        </div>
