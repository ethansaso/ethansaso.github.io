            ...
            <div className="project-section flex flex-row gap-8 flex-wrap">
                <div className="bg-base-300 min-h-full border border-neutral rounded-2xl flex flex-col lg:flex-row justify-between items-center w-full md:w-[45%] lg:w-full flex-grow">
                    ...
                    <div className="p-8 flex-grow lg:p-12 flex flex-col lg:w-[60%] w-full">
                        ...
                        <a href="https://taxokeys.org" className="w-full text-center rounded-2xl border border-neutral mt-4 md:mt-2 p-2 hover:border-base-content bg-base-100 transition-all">Visit Site</a>
                    </div>
                </div>
                <div className="bg-base-300 min-h-full border border-neutral rounded-2xl flex flex-col lg:flex-row-reverse justify-between items-center w-full md:w-[45%] lg:w-full flex-grow">
                    ...
                    <div className="p-8 flex-grow lg:p-12 flex flex-col lg:w-[60%] w-full">
                        ...
                        <a href="https://github.com/sammooredev/WebRecon2" className="w-full text-center rounded-2xl border border-neutral mt-4 md:mt-2 p-2 hover:border-base-content bg-base-100 transition-all">Visit Site</a>
                    </div>
                </div>
                <div className="bg-base-300 min-h-full border border-neutral rounded-2xl flex flex-col lg:flex-row justify-between items-center w-full md:w-[45%] lg:w-full flex-grow">
                    ...
                    <div className="p-8 flex-grow lg:p-12 flex flex-col lg:w-[60%] w-full">
                        ...
                        <a href="https://ethansaso.github.io/cal-mens-volleyball" className="w-full text-center rounded-2xl border border-neutral mt-4 md:mt-2 p-2 hover:border-base-content bg-base-100 transition-all">Visit Site</a>
                    </div>
                </div>
            </div>
        </div>
