        ...
        <div id="projects" className="container flex flex-col max-w-7xl mx-auto items-center justify-center mt-16 px-12 lg:px-16">
            ...
            <div className="project-section">
                <div className="flex flex-col xl:flex-row justify-between mb-8 items-center">
                    <img className="h-auto rounded-2xl object-cover xl:h-96 w-[40%]" src={TaxoKeys} alt="TaxoKeys"/>
                    <div className="flex-grow p-12 flex flex-col xl:w-[60%]">
                        ...
                        <a href="https://taxokeys.org" className="w-full text-center rounded-2xl border border-neutral mt-5 p-3 hover:border-base-content bg-base-100 transition-all">Visit Site</a>
                    </div>
                </div>
                <div className="flex flex-col xl:flex-row-reverse justify-between mb-8 items-center">
                    <img className="h-auto rounded-2xl object-cover xl:h-96 w-[40%]" src={WebRecon2} alt="Web Recon 2"/>
                    <div className="flex-grow p-12 flex flex-col xl:w-[60%]">
                        <div className="w-full border-b border-neutral mb-1">
                        ...
                        <a href="https://github.com/sammooredev/WebRecon2" className="w-full text-center rounded-2xl border border-neutral mt-5 p-3 hover:border-base-content bg-base-100 transition-all">Visit Site</a>
                    </div>
                </div>
                <div className="flex flex-col xl:flex-row justify-between mb-8 items-center">
                    <img className="h-auto rounded-2xl object-cover xl:h-96 w-[40%]" src={Volleyball} alt="Cal Men's Volleyball"/>
                    <div className="flex-grow p-12 flex flex-col xl:w-[60%]">
                        <div className="w-full border-b border-neutral mb-1">
                            <div>
                        ...
                        <a href="https://ethansaso.github.io/cal-mens-volleyball" className="w-full text-center rounded-2xl border border-neutral mt-5 p-3 hover:border-base-content bg-base-100 transition-all">Visit Site</a>
                    </div>
                </div>
            </div>
        </div>
