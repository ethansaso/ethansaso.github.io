...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="container flex flex-col lg:flex-row gap-8 mx-auto items-stretch justify-center px-8 2xl:px-32 mb-48"
    >
      <div className="flex flex-col border border-neutral bg-base-100 rounded-2xl flex-1 p-8 relative">
        <h1 className="text-2xl font-bold mb-7">About me</h1>
        <div
          className={classNames(
            "text-[17px] leading-[1.5] font-medium text-neutral-content",
            { "max-h-80 overflow-hidden": showReadMore }
          )}
        >
          <p className="mb-4">
            Hi! I'm Ethan, a software engineer dedicated to building beautiful
            products with code.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            I quickly became hooked on software development, diving into topics
            ranging from digital circuit design to modern web architecture. I
            ultimately specialized in full-stack development, since it provided
            me the tools to build projects that solve real-world problems and
            bring my ideas to life.
          </p>
          <p className="mb-4">
            When I'm not engineering new features, you can find me out in the
            hills and/or behind a camera lens. Feel free to check out my
            photography portfolio using the button in the upper right corner!
          </p>
        </div>
        {showReadMore && (
          <div className="absolute bottom-0 left-0 flex justify-center w-full">
            <button
              ...
              className="glass-high px-4 py-1.5 mb-8 rounded-full border border-neutral text-sm z-10 shadow-black/20 shadow-xl hover:scale-105 hover:bg-slate-700 transition-all duration-200"
            >
              Read more
            </button>
      ...
      <div className="xl:w-4/12 flex flex-col border border-neutral bg-base-100 rounded-2xl p-8">
        <h1 className="text-2xl font-bold mb-7">Experience</h1>
        <ol className="flex flex-col gap-7">
            ...
            <div className="font-medium ml-5 text-xs w-full">
              <div className="flex justify-between gap-2 sm:gap-4">
                <a
                  ...
                  className="rounded-full px-2 -my-0.5 -ml-2 py-0.5 hover:bg-slate-700 transition-color duration-200 text-sm"
                >
                  Apteron (HUMR)
                </a>
          ...
          <li className="flex">
            ...
            <div className="font-medium ml-5 text-xs w-full">
              ...
              <div className="mt-0.5 text-neutral-content">Academic Intern</div>
            </div>
          </li>
        </ol>
      </div>
